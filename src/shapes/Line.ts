...
class Line implements Shape {
    ...
    isShapeSelected(coords: Coor) {
        return (
            ...
            Math.min(this.shapeData.left, this.shapeData.leftStart) <= coords.left
            ...
            && Math.floor(((this.shapeData.left - this.shapeData.leftStart) * (coords.top - this.shapeData.topStart)) / 5000)
            == Math.floor(((this.shapeData.top - this.shapeData.topStart) * (coords.left - this.shapeData.leftStart)) / 5000)
        )
    }
